...
//        H2O.CLOUD_MULTICAST_IF = null;
  ...
  /**
   * Returns a new connection of type {@tcpType}, the type can be either
   *   TCPReceiverThread.TCP_SMALL, TCPReceiverThread.TCP_BIG or
   *   TCPReceiverThread.TCP_EXTERNAL.
   *
   * If socket channel factory is set, the communication will be either secured or not ( based on the
   * configuration of the factory ). In case factory is null, the communication won't be secured.
